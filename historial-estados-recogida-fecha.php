    ...
    <main class="contenido-principal">
         ...
         <center>
            <h1>WebService Actual: 
                <span>Historial Estados Recogida por Fecha</span>
            </h1>
            <h4>
                <span>Devuelve un listado de las recogidas cuyos estados han sufrido modificaciones en un rango de fechas.</span> 
            </h4>
        </center>
...
require_once('inc/funciones/nusoap.php');
    ...
    $resultado = $client->call('HistorialEstadosRecogidaPorFecha', $param);
            ...
            <div class="listado-pendientes">
                ...
                <center> 
                    <table border="1" style=" border-collapse: collapse;" >
                        <?php
	                        if(isset($_POST["submit"]) && !empty($_POST["submit"])) {
                                $result= $resultado['HistorialEstadosRecogidaPorFechaResult'];
