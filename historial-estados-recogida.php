    ...
    <main class="contenido-principal">
         ...
         <center>
            <h1>WebService Actual: 
                <span>Historial Estados Recogida</span>
            </h1>
            <h4>
                <span>Devuelve un listado de los estados por los que ha pasado una recogida desde su entrada en la red. </span> 
            </h4>
        </center>
                        ...
                        <?php
	                        if(isset($_POST["submit"]) && !empty($_POST["submit"])) {
                                ...
                                echo "<tr ><td width='15%'>4.Valor: </td><td width='85%'>";
                                   if($result['Value'] == null ){}else {var_dump($result['Value']);} 
